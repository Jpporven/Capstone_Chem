...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XR ToogleAttach"",
            ""id"": ""1b107acd-235c-4963-8ba6-4817164e001f"",
            ""actions"": [
                {
                    ""name"": ""Deattach"",
                    ""type"": ""Button"",
                    ""id"": ""3e2cac1b-0f97-4948-824e-bf011f219dc2"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
    ...
    public struct XRToogleAttachActions
    {
        ...
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(XRToogleAttachActions set) { return set.Get(); }
        public void AddCallbacks(IXRToogleAttachActions instance)
        {
            if (instance == null || m_Wrapper.m_XRToogleAttachActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_XRToogleAttachActionsCallbackInterfaces.Add(instance);
        ...
        {
            if (m_Wrapper.m_XRToogleAttachActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IXRToogleAttachActions instance)
        {
            foreach (var item in m_Wrapper.m_XRToogleAttachActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_XRToogleAttachActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    public XRToogleAttachActions @XRToogleAttach => new XRToogleAttachActions(this);
